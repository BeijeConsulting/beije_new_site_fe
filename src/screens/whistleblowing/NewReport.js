...
const NewReport = (props) => {
  ...
  const validate = (values) => {
    ...
    if (!!values?.email && !/^\S+@\S+\.\S+$/.test(values.email)) {
      errors.email = t("form.errorMessage.emailInvalid");
    }
    return errors;
  };
          ...
          <Grid container className="whistleblowing-text-container">
            ...
            <Grid item xs={12}>
              <TextField
                ...
                helperText={formikReport.touched.subject && Boolean(formikReport.errors.subject) && t("form.errorMessage.subject")}
            ...
            <Grid item xs={12}>
              <TextField
                ...
                helperText={formikReport.touched.description && Boolean(formikReport.errors.description) && t("form.errorMessage.description")}
                onChange={formikReport.handleChange}
                onBlur={formikReport.handleBlur}
            ...
            <Grid item xs={12}>
              ...
              >
                ...
                <FormHelperText>{formikReport.touched.category && Boolean(formikReport.errors.category) && t("form.errorMessage.category")}</FormHelperText>
              </FormControl>
            </Grid>
              ...
              <>
                <Grid item xs={12}>
                  <TextField
                    ...
                    helperText={formikReport.touched.name && Boolean(formikReport.errors.name) && t("form.errorMessage.name")}
                    onChange={formikReport.handleChange}
                    onBlur={formikReport.handleBlur}
                ...
                <Grid item xs={12}>
                  <TextField
                    ...
                    helperText={formikReport.touched.surname && Boolean(formikReport.errors.surname) && t("form.errorMessage.surname")}
                    onChange={formikReport.handleChange}
                    onBlur={formikReport.handleBlur}
                    variant="standard"
                    size="normal"
