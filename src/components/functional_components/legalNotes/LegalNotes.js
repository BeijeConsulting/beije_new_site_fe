  ...
  return (
    <div style={{ color: "#262E36" }}>
      ...
      >
        ...
        <a href="https://www.peoplefirst.ws" target={"_blank"} rel="noreferrer">https://peoplefirst.ws</a>
        <span>
      ...
      <ul>
        ...
        <li>{t("legalNotes.list1.li2")} <a href="https://www.peoplefirst.ws" target={"_blank"} rel="noreferrer"> https://www.peoplefirst.ws</a>;</li>
