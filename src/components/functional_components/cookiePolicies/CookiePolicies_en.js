...
const CookiePolicies_en = () => {
  return (
    ...
    >
      ...
      <p ><strong><span >CATEGORIES OF COOKIES USED BY THE DATA CONTROLLER</span></strong></p>
      <div >
        <ul >
          <li ><em><span >Technical cookies&nbsp;</span></em></li>
        </ul>
      </div>
      <p ><span >Technical cookies come from the website you are viewing and may be permanent or temporary; they are used to store information that will be reused the next time you visit the site.</span></p>
      <p ><span >These cookies are useful to us in order to make it quick and easy for you to navigate our sites or to store your login credentials for our services. Where applicable, we protect cookies and other similar technologies to ensure that only the Data Controller and/or our authorised service providers can interpret them by assigning a unique code. Your personal data is not stored in cookies or other similar technologies used.</span></p>
      <p ><span >The use of these cookies may be operationally necessary for the operation of sites, services, applications and tools. This includes technologies that allow you to access sites, services, applications and tools required to prevent fraudulent activity and improve security or to use other features such as shopping carts, saved searches or similar functions.</span></p>
      <div >
        <ul >
          <li ><em><span >Third party Analyticsl analysis cookies</span></em></li>
        </ul>
      </div>
      <p ><span >Analyticsl analysis cookies are used to help us understand how many users are browsing and what content they like the most and to help us improve our services.&nbsp;</span></p>
      <p ><span >The uses of these technologies fall into the following general categories.</span></p>
      <p ><span >Performance-related uses. We may use cookies, web beacons or other similar technologies to evaluate the performance of our websites, applications, tools and services, including as part of analytics to understand how visitors use our website, to determine if they have interacted with our messaging system or viewed an item or link, or to improve our website content, applications, services or tools.</span></p>
      <p ><span >Functionality-related use. We may use cookies, web beacons or other similar technologies to provide you with enhanced functionality when you access or use our sites, services, applications or tools. With these features we can, for example, identify users who access our sites or track their preferences, interests, or previously viewed items so that we can improve the presentation of content on our sites.</span></p>
      <p ><span >Among these Analyticsl analysis cookies, the Data Controller uses, for example:</span></p>
      <p ><a href="https://developers.google.com/analytics/devguides/collection/analyticsjs/cookie-usage?hl=it"><span >Google Analytics</span></a></p>
      <p ><span >The Owner also uses the services of Google Analytics to collect and monitor the performance of the Site in order to generate exclusively aggregate reports without carrying out any so-called single-out and, therefore, cannot identify you or track your online behaviour.&nbsp;</span></p>
      <p ><span >Google Analytics uses a simple JavaScript code that is added to each page and places a cookie on your browser. The cookie, in turn, sends a hit to the Owner&apos;s Google Analytics which reports every interaction that takes place on the Site, in order to record information about the pages visited. This activity creates libraries that use HTTP cookies to track user behaviour on the Site at a purely aggregate level.</span></p>
      <p ><span >Google Analytics collects information on the number of visits to the Site, behaviour in relation to the way users interact with the various active elements, or how long users spend on average on the Site.&nbsp;</span></p>
      ...
      <p ><span >If consent has already been given but you wish to change the cookie permissions, you must delete them through your browser, as indicated below, otherwise those already installed will not be removed. In particular, keep in mind that it is not possible in any way to control third party cookies, so if consent has already been given previously, you must proceed to delete the cookies through your browser (dedicated section) or by requesting the opt-out directly from the third parties or through the&nbsp;</span><a href="http://www.youronlinechoices.com/it/le-tue-scelte"><span >http://www.youronlinechoices.com/it/le-tue-scelte</span></a><span >&nbsp;website.</span></p>
      <p ><span >If you would like to find out more, please visit the following sites:</span></p>
      ...
      <p ><span >In the &quot;Privacy&quot; section click on the Content Settings button</span></p>
      <p ><span >In the &quot;Cookies&quot; section you can change the following settings related to cookies:</span></p>
      <p ><span >Allow local data to be saved</span></p>
      <p ><span >Change local data only until you close your browser</span></p>
      <p ><span >Prevent sites from setting cookies</span></p>
      <p ><span >Block third-party cookies and site data</span></p>
      ...
      <p ><span >In the Tracking section you can change the following settings related to cookies:</span></p>
      <p ><span >Require sites not to perform any tracking</span></p>
      <p ><span >Notify sites of their willingness to be tracked</span></p>
      <p ><span >Do not communicate any preference regarding the tracking of personal data</span></p>
      <p ><span >From the History section you can:</span></p>
      ...
      <p ><span >Accept cookies only from the site you are visiting: third-party cookies and cookies that are sent from a domain other than the one you are visiting will be rejected</span></p>
      ...
      <table >
        <tbody>
          <tr>
            ...
            <td >
              <p ><strong><span >Name of the domain</span></strong></p>
            </td>
            <td >
              <p ><strong><span >Storage time&nbsp;</span></strong></p>
            </td>
            <td >
            ...
            <td >
              <p ><strong><span >Functioning</span></strong></p>
            </td>
            <td >
              <p ><strong><span >Cookie Policy</span></strong></p>
            </td>
          ...
          <tr>
            <td >
              <p ><strong><span >_ga</span></strong></p>
            </td>
            <td >
              <p ><span >Google-Analytics.com</span></p>
            </td>
            <td >
            ...
            <td >
              <p ><em><span >It records a unique ID used to generate statistical data on how the visitor uses the website..</span></em></p>
            </td>
            <td >
              <p ><a href="https://support.google.com/analytics/answer/6004245" target="_blank" rel="noreferrer"><span >https://support.google.com/analytics/answer/6004245</span></a></p>
            </td>
          </tr>
          <tr>
            <td >
              <p ><strong><span >_gat</span></strong></p>
            </td>
            <td >
              <p ><span >Google-Analytics.com</span></p>
            </td>
            ...
            <td >
              <p ><em><span >This cookie is used to read and filter requests from bots.</span></em></p>
            </td>
            <td >
              <p ><a href="https://support.google.com/analytics/answer/6004245" target="_blank" rel="noreferrer"><span >https://support.google.com/analytics/answer/6004245</span></a></p>
            </td>
          ...
          <tr>
            <td >
              <p ><strong><span >_gid</span></strong></p>
            </td>
            <td >
              <p ><span >Google-Analytics.com</span></p>
            </td>
          ...
          <tr>
            <td >
              <p ><strong><span >_clck</span></strong></p>
            </td>
            <td >
              <p ><span >Microsoft Clarity</span></p>
            </td>
            <td >
            ...
            <td >
              <p ><em><span >This cookie is installed by Microsoft Clarity to store information about how visitors use a website and to help create an analytical report on website performance. The data collected includes the number of visitors, the source they come from and the pages they visit in an anonymous form.</span></em></p>
            </td>
            <td >
              <p ><a href="https://docs.microsoft.com/en-us/clarity/cookie-list"><span >https://docs.microsoft.com/en-us/clarity/cookie-list</span></a></p>
              <p ><span >&nbsp;</span></p>
            </td>
          </tr>
          <tr>
            <td >
              <p ><strong><span >&nbsp;</span></strong><strong><span >_clsk</span></strong></p>
            </td>
            <td >
              <p ><span >Microsoft Clarity</span></p>
            </td>
            ...
            <td >
              <p ><em><span >This cookie is installed by Microsoft Clarity to store information about how visitors use a website and help create an analytical report on website performance. .</span></em></p>
            </td>
            <td >
              <p ><a href="https://docs.microsoft.com/en-us/clarity/cookie-list"><span >https://docs.microsoft.com/en-us/clarity/cookie-list</span></a></p>
              <p ><span >&nbsp;</span></p>
          ...
          <tr>
            <td >
              <p ><strong><span >CLID</span></strong></p>
            </td>
            <td >
              <p ><span >Microsoft Clarity</span></p>
            </td>
            ...
            <td >
              <p ><em><span >This cookie is installed by Microsoft Clarity and stores information about how visitors use the website. The cookie contributes to the creation of an analysis report. The data collection includes the number of visitors, where they visit the website from and the pages they visit on the website.</span></em></p>
            </td>
            <td >
              <p ><a href="https://docs.microsoft.com/en-us/clarity/cookie-list"><span >https://docs.microsoft.com/en-us/clarity/cookie-list</span></a></p>
              <p ><span >&nbsp;</span></p>
          ...
          <tr>
            <td >
              <p ><strong><span >MUID</span></strong></p>
            </td>
            <td >
              <p ><span >Microsoft Clarity</span></p>
            </td>
            ...
            <td >
              <p ><em><span >This cookie is used by Microsoft as a unique identifier. The cookie is set by embedded Microsoft scripts. The purpose of this cookie is to synchronise the ID between many different Microsoft domains to allow tracking of users.</span></em></p>
            </td>
            <td >
              <p ><a href="https://docs.microsoft.com/en-us/clarity/cookie-list"><span >https://docs.microsoft.com/en-us/clarity/cookie-list</span></a></p>
              <p ><span >&nbsp;</span></p>
      ...
      <p ><strong><span >&nbsp;</span></strong></p>
      <p ><strong><span >If you visit the Site after logging into your Google account, we would like to inform you that other cookies may also be active, including for example:</span></strong></p>
      <table >
        <tbody>
          <tr>
            <td >
          ...
          <tr>
            <td>
              <p ><strong><span >ANID</span></strong></p>
            </td>
            <td>
            ...
            <td>
              <p><em><span>The &apos;ANID&apos; cookie is used for advertisements promoted on the web and stored in google.com.</span></em></p>
            </td>
            <td>
              <p ><a href="https://google.com"><span>https://google.com</span></a></p>
              <p ><span>&nbsp;</span></p>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <p ><span >Techincal</span></p>
            </td>
            <td>
              <p ><em><span >to store your cookie consent preferences.</span></em></p>
            </td>
            <td>
              <p ><a href="https://google.com"><span>https://google.com</span></a></p>
              <p ><span>&nbsp;</span></p>
          ...
          <tr>
            <td>
              <p ><strong><span >NID</span></strong></p>
            </td>
            <td>
              <p ><span >Google Ads</span></p>
            </td>
            <td>
              <p ><span >6 months</span></p>
            </td>
            <td>
              <p ><span >HTTP</span></p>
            </td>
            ...
            <td >
              <p ><em><span >to provide ad serving or retargeting, store user preferences.</span></em></p>
            </td>
            <td >
              <p ><a href="https://ads.google.com"><span>https://ads.google.com</span></a></p>
              <p ><span>&nbsp;</span></p>
            </td>
          </tr>
        </tbody>
...
export default CookiePolicies_en